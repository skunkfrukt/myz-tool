...
function sumInto() {
    var $this = $(this);
    var targetId = $this.data("sum-into");
    var sum = 0;
    $("[data-sum-into='" + targetId + "']").each(function () {
        sum += parseIntOrDefault($(this).val(), 0);
    });
    $("#" + targetId).val(sum);
}
...
$(document).ready(function () {
    ...
    $("button#roll-protection").click(rollProtection);
